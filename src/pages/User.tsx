        ...
        <>
            ...
            {!loading && user !== null && (
                <>
                    ...
                    <Row className="my-2" style={{ border: "1px solid lightgrey", padding: "1rem" }}>
                        ...
                        <Col sm={12} md={6}>
                            ...
                            <ul style={{ listStyle: 'none', paddingInlineStart: '0px', marginTop: '0.3rem' }}>
                                ...
                                <li>{user.blog && <p>website : {user.blog}</p>}</li>
                            </ul>
                        </Col>
                    </Row>
                    <Row className="justify-content-center my-2 py-2" style={{ border: "1px solid lightgrey" }}>
